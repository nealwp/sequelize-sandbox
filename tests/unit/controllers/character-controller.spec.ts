...
describe('character controller', () => {
    ...
    describe('update', () => {
        test('should throw an error if character does not exist', async () => {
            ...
            await expect(async () => await characters.update(character)).rejects.toThrow(
                `Character id ${character.id} not found!`,
            );
        });
    ...
    describe('findById', () => {
        test('should throw an error if character does not exist', async () => {
            ...
            await expect(async () => await characters.findById(characterId)).rejects.toThrow(
    ...
    describe('findAll', () => {
        test('should return an array of characters', async () => {
            Character.findAll = jest.fn().mockResolvedValue(['found some characters']);
