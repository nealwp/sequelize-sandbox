...
describe('character controller', () => {
    ...
    describe('create', () => {
        ...
        test('should create a new character', async () => {
            ...
            const [dbContents] = await db.client.query(`select * from characters where id = ${result.id}`, {
    ...
    describe('update', () => {
        ...
        test('should update an existing character', async () => {
            ...
            const [dbContents] = await db.client.query(`select * from characters where id = ${character.id}`, {
                type: QueryTypes.SELECT,
            });
            expect(dbContents).toEqual(result.toJSON());
        });
